  				...
  				<div class="card-body" style="background-color: white;">
					...
					<table style="min-width:100%;">
						<tr>
					   	...
					   	<tr>
					   		<td>Grams</td><td><input type="number" style="width:100%; text-align: right;" ng-model="recgram[item.id]" ng-change="recount(item.id, recgram[item.id])" ng-init="recgram[item.id]=1"></td>
					   	</tr>
					</table>
				</div>
  				</div>
